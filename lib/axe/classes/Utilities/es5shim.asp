...
AXE(ASP Xtreme Evolution) ES5 Shim is based on the work being made at
<https://github.com/es-shims/es5-shim>.

ES5 Shim monkey-patch a JavaScript context to contain all EcmaScript 5 methods
